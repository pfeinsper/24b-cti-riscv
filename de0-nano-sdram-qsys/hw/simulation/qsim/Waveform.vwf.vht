...
-- *****************************************************************************
-- Generated on "10/23/2024 16:29:21"
...
SIGNAL GPIO_i : STD_LOGIC_VECTOR(12 DOWNTO 0);
SIGNAL GPIO_o : STD_LOGIC_VECTOR(12 DOWNTO 0);
...
COMPONENT top
	...
	GPIO_o : BUFFER STD_LOGIC_VECTOR(12 DOWNTO 0);
	HALL_GPIO_i : IN STD_LOGIC;
	KEY : IN STD_LOGIC_VECTOR(1 DOWNTO 0);
	LED : BUFFER STD_LOGIC_VECTOR(7 DOWNTO 0);
	MSW_IRQ : IN STD_LOGIC;
	PWM : BUFFER STD_LOGIC_VECTOR(3 DOWNTO 0);
	SW : IN STD_LOGIC_VECTOR(3 DOWNTO 0);
	sys_clk_port : BUFFER STD_LOGIC;
	TCK_i : IN STD_LOGIC;
	TDI_i : IN STD_LOGIC;
	TDO_o : BUFFER STD_LOGIC;
	TMS_i : IN STD_LOGIC;
	UART0_RXD : IN STD_LOGIC;
	UART0_TXD : BUFFER STD_LOGIC;
